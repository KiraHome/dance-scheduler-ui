...
export const timeTableEvents: CalendarEvent[] = [
  {
    start: addMinutes(addHours(addDays(startOfDay(new Date()), 0), 17), 30),
    end: addMinutes(addHours(addDays(startOfDay(new Date()), 0), 18), 30),
  ...
  {
    start: addMinutes(addHours(addDays(startOfDay(new Date()), 0), 18), 30),
    end: addMinutes(addHours(addDays(startOfDay(new Date()), 0), 19), 30),
  ...
  {
    start: addMinutes(addHours(addDays(startOfDay(new Date()), 2), 17), 30),
    end: addMinutes(addHours(addDays(startOfDay(new Date()), 2), 18), 30),
